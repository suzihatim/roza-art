					...
					<?php $i=0; foreach( $extensions as $key=>$ext ){ ?>
						<div class="col-sm-4 mod-widget">
							...
							<div class="mod-items">
								...
								<div class="module-item so-page-widget" data-module="<?php echo $emod['module'] ; ?>" data-type="module" data-name="<?php echo $emod['name'];?>">
									<div class="w-inner">
										<div class="so-page-wicon"><i class="fa fa-university"></i></div>
										<div class="widget-title">
											<p><?php echo $emod['code'];?></p>
											<span class="widget-title-edit"><?php echo $emod['name'];?></span>
										</div>
									</div> <?php //.w-inner ?>
